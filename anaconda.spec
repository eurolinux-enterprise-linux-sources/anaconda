...
Name:    anaconda
Patch1:	sl-branding-installclass.patch
Patch2:	sl-branding-bootloader-xfs.patch
Patch3:	anaconda-context-treeinfo-DVD-72.patch
Patch4:	anaconda-doesnt-use-yumvars-for-mirrorlist.patch
Patch5:	anaconda-expand-yumvars-in-script.patch
Version: 21.48.22.156
Release: 1%{?dist}
...
Source2:	anaconda_spec-dont-use-rhel-bugzilla.patch
Source3:	anaconda.ini
...
%changelog
* Mon Dec 23 2019 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> 
- This version **was not** used in EL 7.7
- Changed sl-branding-patch

* Thu Aug 08 2019 Scientific Linux Auto Patch Process <SCIENTIFIC-LINUX-DEVEL@LISTSERV.FNAL.GOV>
- Added Patch: anaconda-context-treeinfo-DVD-72.patch
-->  Permit selective enabling of 'addon' repos (for contexts)
- Added Source: anaconda_spec-dont-use-rhel-bugzilla.patch
-->  Do not configure anaconda to autoreport errors to TUV
- Added Patch: sl-branding-bootloader-xfs.patch
-->  Modify filesystem list in pyanaconda/bootloader.py for SL
- Added Patch: anaconda-doesnt-use-yumvars-for-mirrorlist.patch
-->  Anaconda doesn't use yumvars for mirrorlists in UI, do it by hand
- Added Source: anaconda.ini
-->  Config file for automated patch script
- Added Patch: anaconda-expand-yumvars-in-script.patch
-->  Anaconda doesn't use yumvars for mirrorlists in script, do it by hand
- Added Patch: sl-branding-installclass.patch
-->  Modify installclasses/rhel.py and installclasses/fedora.py for SL
