...
Name:    anaconda
Patch1:	anaconda-no-addons-recognize-sl.patch
Patch2:	anaconda-scientific-linux-installclasses.patch
Patch3:	anaconda-eurolinux.installclasses.patch
Patch4:	anaconda-add-gdisk.patch
Version: 13.21.263
Release: 1.el6
License: GPLv2+
...
%changelog
* Fri Jul 13 2018 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> 13.21.263-1
- Added patch anaconda-eurolinux-installclasses.patch
- Dist sl6 -> el6

* Tue Mar 21 2017 Scientific Linux Auto Patch Process <SCIENTIFIC-LINUX-DEVEL@LISTSERV.FNAL.GOV>
- Added Patch: anaconda-no-addons-recognize-sl.patch
-->  Disables the check for the TUV addons during a DVD install
- Added Patch: anaconda-scientific-linux-installclasses.patch
...
- Added Patch: anaconda-add-gdisk.patch
-->  Make sure gdisk is on install media
